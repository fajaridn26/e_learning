                            ...
                            <div class="d-lg-flex align-items-start">
                                ...
                                <div class="tab-content nxl-mega-menu-tabs-content">
                                    ...
                                    <div class="tab-pane fade show active" id="v-pills-general" role="tabpanel">
                                        ...
                                        <p class="fs-12 fw-normal text-muted text-truncate-3-line">Get started Duralux
                                            with Duralux up and running. Duralux bootstrap template docs helps you to
                                            get started with simple html codes.</p>
                                        ...
                                        <div class="d-lg-flex align-items-center justify-content-between">
                                            <div>
                                                <h6 class="menu-item-heading text-truncate-1-line">Need more
                                                    application?</h6>
                                                <p class="fs-12 text-muted mb-0 text-truncate-3-line">We are ready to
                                                    build custom applications.</p>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-integrations" role="tabpanel">
                                        <div class="row g-lg-4 nxl-mega-menu-integrations">
                                            <div
                                                ...
                                                <div class="mt-2 mt-lg-0">
                                                    <a href="javascript:void(0);" class="fs-13 text-primary">Add New
                                                        &rarr;</a>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="javascript:void(0);" class="dropdown-item">
                                                    <div class="menu-item-icon">
                                                        <img src="assets/images/brand/google-drive.png" alt=""
                                                            class="img-fluid" />
                                                    </div>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <a href="javascript:void(0);" class="dropdown-item">
                                                    <div class="menu-item-icon">
                                                        <img src="assets/images/brand/pinterest.png" alt=""
                                                            class="img-fluid" />
                                                    </div>
                                        ...
                                        <p class="fs-13 text-muted mb-0">Need help? Contact our <a
                                                href="javascript:void(0);" class="fst-italic">support center</a></p>
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-components" role="tabpanel">
                                        <div class="row g-4 align-items-center">
                                            ...
                                            <div class="col-xl-4">
                                                ...
                                                <div class="mt-4">
                                                    <a href="mailto:flexilecode@gmail.com" class="fs-13 fw-bold">View
                                                        all resources on Duralux &rarr;</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="carousel-inner rounded-3">
                                                        <div class="carousel-item active">
                                                            ...
                                                            <div class="carousel-caption">
                                                                ...
                                                                <p class="carousel-caption-desc">Some representative
                                    ...
                                    <div class="tab-pane fade nxl-mega-menu-miscellaneous" id="v-pills-miscellaneous"
                                        role="tabpanel">
                                        <!-- Nav tabs -->
                                        <ul class="nav nav-tabs flex-column flex-lg-row nxl-mega-menu-miscellaneous-tabs"
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link active" data-bs-toggle="tab"
                                                    data-bs-target="#v-pills-projects" type="button" role="tab">
                                                    <span class="menu-icon">
                                                        <i class="feather-cast"></i>
                                                    </span>
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link" data-bs-toggle="tab"
                                                    data-bs-target="#v-pills-blogs" type="button" role="tab">
                                                    <span class="menu-icon">
                                                                ...
                                                                <div class="d-lg-flex align-items-center gap-3">
                                                                    ...
                                                                    <div class="mt-3 mt-lg-0 ms-lg-3 item-text">
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            adipisicing elit. Sint nam ullam iure eum
                                                                            sed rerum libero quis doloremque maiores
                                                                            veritatis?</p>
                                                                ...
                                                                <div class="d-flex align-items-start gap-3">
                                                                    ...
                                                                    <div>
                                                                        <a href="javascript:void(0);">
                                                                            <h6
                                                                                class="menu-item-heading text-truncate-1-line">
                                                                                SEO (Search Engine Optimization)</h6>
                                                                        </a>
                                                                        <p
                                                                            class="fs-12 fw-normal text-muted mb-0 text-truncate-2-line">
                                                                            Lorem ipsum dolor sit amet consectetur
                                                            ...
                                                            <div class="col-xxl-4 col-lg-6">
                                                                <div class="d-flex align-items-center gap-3">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <span class="fs-11 text-gray-500">26 March,
                                                                            2023</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                            ...
                            <div class="users-result px-4 py-2">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <a href="javascript:void(0);"
                                                class="font-body fw-bold d-block mb-1">{{ auth()->user()->name }}</a>
                    ...
                    <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                        <div class="dropdown-header">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="text-dark mb-0" id="userName"></h6>
                                    <span class="fs-12 fw-medium text-muted" id="userEmail"></span>
                                </div>
                            </div>
                        </div>
                        {{-- <div class="dropdown">
