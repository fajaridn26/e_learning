    ...
    <main class="nxl-container">
        <div class="nxl-content">
            ...
            <div class="main-content">
                ...
                @elseif(session('updateRoleSuccess'))
                    <div class="alert alert-success" role="alert">
                                                ...
                                                <tr class="single-item">
                                                        ...
                                                        <div class="item-checkbox ms-1">
                                                            <div class="custom-control custom-checkbox">
                                                                <input type="checkbox"
                                                                    ...
                                                                    id="checkBox_1{{ $user->id }}">
                                                                <label class="custom-control-label"
                                                                    for="checkBox_1{{ $user->id }}"></label>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>{{ $user->name }}</td>
                                                    ...
                                                    <form action="{{ route('users.updateRole', $user->id) }}"
                                                        ...
                                                        <td><select class="form-control" name="role"
                                                                ...
                                                                <option value="Dosen" data-bg="bg-primary"
                                                                    {{ $user->role == 'Dosen' ? 'selected' : '' }}>Dosen
                                                                </option>
                                                                <option value="Mahasiswa" data-bg="bg-warning"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="text-center">
                                <h5>Mahasiswa <span class="text-primary">{{ $user->name }}</span> akan dihapus!</h5>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
