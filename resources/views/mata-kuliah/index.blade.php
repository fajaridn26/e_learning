...
<tr class="single-item">
                                                    ...
                                                    <div class="hstack gap-2 justify-content-end">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item" href="javascript:void(0)" data-bs-target="#editModal{{ $course->id }}" data-bs-toggle="modal">
                                                                        <i class="feather feather-edit-3 me-3"></i>
                                                                        <span>Edit</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a class="dropdown-item" href="javascript:void(0)" data-bs-target="#deleteModal{{ $course->id }}" data-bs-toggle="modal">
   ...
   @foreach ($courses as $course)
    ...
    <form action="{{ route('courses.destroy', $course->id) }}" method="POST">
        @csrf
        @method('DELETE')
        <div class="modal fade" id="deleteModal{{ $course->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                       <div class="text-center">
                        <h5>Mata kuliah <span class="text-primary">{{ $course->name }}</span> akan dihapus!</h5>
                       </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
